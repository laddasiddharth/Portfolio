  ...
  return (
    <div
      className={
        cn
          ? cn(
              "relative h-[24rem] md:h-screen w-full bg-gray-50 dark:bg-black",
              className
            )
          : `relative h-screen w-full bg-gray-50 dark:bg-black ${className ?? ""}`
      }
    >
    ...
    >
      ...
      {circuits.map((path, idx) => (
        <motion.path
          ...
          strokeLinecap="round"
          className="dark:stroke-[url(#circuitGradientDark)] dark:[filter:url(#circuitGlowDark)] dark:!stroke-[3]"
